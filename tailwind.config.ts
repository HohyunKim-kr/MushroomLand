  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        // maple: ['Maplestory', 'sans-serif'] // Maplestory 폰트 로드 문제로 주석 처리 유지
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      keyframes: {
        ...
        idleAnim: {
          ...
          '100%': { backgroundPosition: '-675px 0' },
        },
        moveAnim: {
          '0%': { backgroundPosition: '0 0' },
          '100%': { backgroundPosition: '-675px 0' },
      ...
      animation: {
        ...
        idle: 'idleAnim 1s steps(5) infinite',
        move: 'moveAnim 0.5s steps(5) infinite',
      },
      backgroundImage: {
        ...
        'mp-background': "url('/mpbackground.png')",
      },
      boxShadow: {
